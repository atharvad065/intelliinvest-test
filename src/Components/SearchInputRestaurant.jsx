...
function SearchInputRestaurant() {
  return (
    <>
    <div className='bg-white h-14 w-full flex gap-2 rounded-lg shadow-lg border-1-8 border-red-600'>
...
export default SearchInputRestaurant
